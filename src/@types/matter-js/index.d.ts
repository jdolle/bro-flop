// tslint:disable
// originally from @types, but there were some bugs...
declare module 'matter-js' {
  ...
  namespace Matter {
      ...
      */
      ...
      type worldElement = Body | Composite | Constraint | MouseConstraint
      ...
      */
      export class World extends Composite {
           ...
           * @returns world
           */
          static add(world: World, body: worldElement | worldElement[]): World;
